...
-- CHATINDEX defines the position in which the output we want to get so the , 
-- is the delimiter the name of the column and the -1 is for the postion to get the , out
...
-- parsename takes the string of the place '1,2,3'
-- Replace makes the (,) to a . because parsename default delimiter is (.) 
